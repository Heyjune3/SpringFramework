...
public class BoardController {
	...
	public String readPage(int bno,RedirectAttributes rttr) throws Exception{
		...
		// addFlashAttribute = redirect 된 attribute에 model 정보 전달
		// Attribute = redirect 된 attribute에 parameter 정보 전달
		// redirect된 페이지에 get 방식의 QueryString parameter 전달
	...
	// 답변글 등록 요청 처리
	// 같은 replyRegister지만 전송방식으로 구분 가능
